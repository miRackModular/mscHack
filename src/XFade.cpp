...
XFade_Widget::XFade_Widget( XFade *module ) : ModuleWidget(module) 
{
    ...
    setPanel(APP->window->loadSvg(asset::plugin( thePlugin, "res/XFade.svg")));
...
Model *modelXFade = Model::create<XFade, XFade_Widget>( "mscHack", "XFade", "MIXER Cross Fader 3 Channel", api0::MIXER_TAG, api0::MULTIPLE_TAG );
