...
Mix_2x4_Stereo_Widget::Mix_2x4_Stereo_Widget( Mix_2x4_Stereo *module ) : ModuleWidget(module) 
{
    ...
    setPanel(APP->window->loadSvg(asset::plugin( thePlugin, "res/Mix_2x4_Stereo.svg")));
...
Model *modelMix_2x4_Stereo = Model::create<Mix_2x4_Stereo, Mix_2x4_Stereo_Widget>( "mscHack", "Mix_2x4_Stereo", "MIXER 2x4 Stereo/Mono (Legacy)", api0::MIXER_TAG, api0::EQUALIZER_TAG, api0::DUAL_TAG, api0::PANNING_TAG, api0::AMPLIFIER_TAG, api0::MULTIPLE_TAG );
